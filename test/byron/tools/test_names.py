...
def test_uncanonize_name():
    ...
    assert byron.tools.names.uncanonize_name("foo<bar#1>") == ""
    ...
    assert byron.tools.names.uncanonize_name("foo<bar>", user=False) == ""
    assert byron.tools.names.uncanonize_name("foo<bar#1>", user=False) == ""
