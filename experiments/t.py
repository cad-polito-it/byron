...
# population = byron.classes.population.Population(top_frame=program, evaluator=None)
# ind = byron.operators.random_individual(top_frame=program)
# population += ind
...
byron.ea.vanilla_ea(program, None)
